...
CREATE TABLE IF NOT EXISTS data_all_edge_001 (
  id BIGINT PRIMARY KEY AUTO_INCREMENT,
  name VARCHAR(128) NOT NULL,
  value VARCHAR(512) NULL,
  sync_version BIGINT NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS data_all_edge_002 LIKE data_all_edge_001;
CREATE TABLE IF NOT EXISTS data_all_edge_003 LIKE data_all_edge_001;
CREATE TABLE IF NOT EXISTS data_all_edge_004 LIKE data_all_edge_001;
CREATE TABLE IF NOT EXISTS data_all_edge_005 LIKE data_all_edge_001;
CREATE TABLE IF NOT EXISTS data_all_edge_006 LIKE data_all_edge_001;
CREATE TABLE IF NOT EXISTS data_all_edge_007 LIKE data_all_edge_001;
CREATE TABLE IF NOT EXISTS data_all_edge_008 LIKE data_all_edge_001;
CREATE TABLE IF NOT EXISTS data_all_edge_009 LIKE data_all_edge_001;
CREATE TABLE IF NOT EXISTS data_all_edge_010 LIKE data_all_edge_001;
